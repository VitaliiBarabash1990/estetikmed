...
import { selectIsSendOrder } from "@/redux/auth/selectors";
...
const FormCallback = () => {
	...
	const isSendOrder = useSelector(selectIsSendOrder);
	...
	const handlerSubmit = (
		...
		{ resetForm }: FormikHelpers<FormCallBackProps>
	) => {
	...
	return (
		<>
			...
			{isSendOrder && (
				<ModalSuccessfull message="Wiadomość wysłana pomyślnie!" />
			)}
		</>
	);
};
