...
export const NavigationMenu = ({ setOpenMenu, openMenu }: MyComponentProps) => {
	...
	const linkDatas: LinkData[] = [
		{ id: 0, link: "AboutMe", text: t("menu.0") },
		{ id: 1, link: "BlogSwiper", text: t("menu.1") },
		{ id: 2, link: "Barber", text: t("menu.2") },
		{ id: 3, link: "Psychologist", text: t("menu.3") },
		{ id: 4, link: "Gallery", text: t("menu.4") },
		{ id: 5, link: "Contacts", text: t("menu.5") },
	];
